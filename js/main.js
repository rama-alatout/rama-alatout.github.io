$(document).ready(function() {
    ...
    var Nexus = {
        ...
        build: function() {
            ...
            this.wow();
            this.runAnimations();
            if(this.mainNavAnimated) {
                this.fixedMenuScroll();
            }
            this.setMargins();
        ...
        fixedMenuScroll: function(externalCall) {
            ...
            var mainNav = this.globalArgs.mainNav,
                ...
                containerMargin = 0,
                menuFixingPoint = $("#section-teaching"),
                menuFixingPointBottom = $("#section-contacts"),
                mainFooterTop = $('.js-main-footer-top');
